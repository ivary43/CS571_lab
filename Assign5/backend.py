def toProfile(epsilon1, epsilon2, epsilon3, x):
    y = -1
    # Caluclate epsilon4 using geometry
...
def fuzzication(epsilon, x):
    ...
    epsilon2 = 0
    epsilon3 = 0
    y_zero = toProfile(epsilon1, epsilon2, epsilon3, x)

    epsilon1 = 0
    epsilon2 = epsilon[1]
    epsilon3 = epsilon[2]
    y_small_pos = toProfile(epsilon1, epsilon2, epsilon3, x)

    epsilon1 = -1 * (epsilon[1] + epsilon[2])
    epsilon2 = -1 * epsilon[2]
    epsilon3 = -1 * (epsilon[1])
    y_small_neg = toProfile(epsilon1, epsilon2, epsilon3, x)
